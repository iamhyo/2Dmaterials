...
MatGAN_Ex = MatGAN.drop(['Ex','Ey'],axis=1)
c2db_Ex = c2db.drop(['Ex','Ey'],axis=1)


# In[7]:


c2db_Ex = c2db_Ex[c2db_Ex['C33']>0]
len(c2db_Ex)
...
reg_1 = setup(data=c2db_Ex, target='C33', train_size =0.8, silent=True, session_id =2222)
...
MatGAN_Ex_cycle_0_X = MatGAN_Ex_cycle_0.drop('C33',axis=1)
MatGAN_Ex_cycle_0_Y = MatGAN_Ex_cycle_0['C33']
...
for i in range(0,20):
    ...
    globals()['MatGAN_Ex_add_{}_Y'.format(i)] = globals()['MatGAN_Ex_add_{}'.format(i)]['C33']
    globals()['MatGAN_Ex_add_{}_X'.format(i)] = globals()['MatGAN_Ex_add_{}'.format(i)].drop('C33',axis=1)
    ...
    globals()['MatGAN_Ex_cycle_{}_Y'.format(i+1)] = globals()['MatGAN_Ex_cycle_{}'.format(i+1)]['C33'].reset_index(drop=bool,inplace=False)
    globals()['MatGAN_Ex_cycle_{}_X'.format(i+1)] = globals()['MatGAN_Ex_cycle_{}'.format(i+1)].drop('C33',axis=1).reset_index(drop=bool,inplace=False)
...
MatGAN_Ex_cycle_1[MatGAN_Ex_cycle_1['C33']<0].sort_values(by='C33')
